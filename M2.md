...
Research Q3: Does the acceptance of credit card relate to parking rates?
...
![](M2_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
```
    ...
    ## 
    ## Call:
    ## lm(formula = avg_rate ~ avg_time, data = m2.1)
    ## 
    ## Coefficients:
    ## (Intercept)     avg_time  
    ##     2.61020     -0.06314
