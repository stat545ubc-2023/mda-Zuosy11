...
The three attributes are chosen to be 1) the number of rows and 2) columns/variables, and 3) the class type. I will use head(), nrow(), and class() to explore the selected datasets.
